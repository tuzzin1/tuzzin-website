...
<template>
    <div class="rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row mx-auto py-4 max-w-5xl mt-3" >
        ...
        <h2 class="text-2xl font-bold mb-2 text-(--ui-primary)">{{ post00.title }}</h2>
    ...
    <div class="rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row mx-auto py-4 max-w-5xl mt-3">
        ...
        <div class="w-full md:w-2/3 px-6 py-4">
        <h2 class="text-2xl font-bold mb-2 text-(--ui-primary)">{{ post01.title }}</h2>
        <p class="text-muted text-base mb-4">
            <!-- {{ post.description}} -->
    ...
    <div class="rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row mx-auto py-4 max-w-5xl mt-3">
        ...
        <div class="w-full md:w-2/3 px-6 py-4">
        <h2 class="text-2xl font-bold mb-2 text-(--ui-primary)">{{ post02.title }}</h2>
        <p class="text-muted text-base mb-4">
            <!-- {{ post.description}} -->
    ...
    <div class="rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row mx-auto py-4 max-w-5xl mt-3">
        ...
        <div class="w-full md:w-2/3 px-6 py-4">
        <h2 class="text-2xl font-bold mb-2 text-(--ui-primary)">{{ post03.title }}</h2>
        <p class="text-muted text-base mb-4">
            <!-- {{ post.description}} -->
    ...
    <div class="rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row mx-auto py-4 max-w-5xl mt-3">
        ...
        <div class="w-full md:w-2/3 px-6 py-4">
        <h2 class="text-2xl font-bold mb-2 text-(--ui-primary)">{{ post04.title }}</h2>
        <p class="text-muted text-base mb-4">
            <!-- {{ post.description}} -->
    ...
    <div class="rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row mx-auto py-4 max-w-5xl mt-3">
        ...
        <div class="w-full md:w-2/3 px-6 py-4">
        <h2 class="text-2xl font-bold mb-2 text-(--ui-primary)">{{ post05.title }}</h2>
        <p class="text-muted text-base mb-4">
            <!-- {{ post.description}} -->
